...
class camera {
    ...
    double defocus_angle = 0;   // Variation angle of rays through each pixel (0 before adding)
    ...
    void initialize(){
        ...
        // calc u, v, w unit basis vecs for cam coordinate frame
        ...
        auto viewport_v = viewport_height * -v;  // top to bottom
    ...
    ray get_ray(int i, int j) {
        // construct camera ray ogirinating from defocus disk,
        // directed at rand sampled pixel location around i, j
    ...
    vec3 sample_square() const {
        // return vector to rand point in [-.5,-.5]-[+.5,+.5] unit square.
        return vec3(random_double() - 0.5, random_double() - 0.5, 0);
    }

    point3 defocus_disk_sample() {
        // return random point in cam defocus disk
